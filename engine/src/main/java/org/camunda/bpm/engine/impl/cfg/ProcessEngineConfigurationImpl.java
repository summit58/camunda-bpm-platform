...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
    ...
    /**
     * If set to true, the engine doesn't use "select for update", which enables support for older CockroachDB
     * versions, such as 19.1.1. Note that - as of CockroachDB 19.2.5 - you also need to remove the recursive
     * foreign keys on ACT_RU_EXECUTION.
     */
    protected static boolean enableLegacyCockroachDbSupport = false;
    ...
    public static void initSqlSessionFactoryProperties(Properties properties, String databaseTablePrefix, String databaseType) {
        ...
        if (databaseType != null) {
            ...
            if(enableLegacyCockroachDbSupport) {
                Map<String,String> constants = DbSqlSessionFactory.dbSpecificConstants.get(DbSqlSessionFactory.POSTGRES);
    ...
    protected void initScripting() {
        ...
        if (scriptingEngines == null) {
            ...
            scriptingEngines.setEnableScriptIO(enableScriptIO);
        }
     ...
     */
    public static void setEnableLegacyCockroachDbSupport(boolean enabled) {
        enableLegacyCockroachDbSupport = enabled;
    }
     ...
     *
     * @since 7.12.2 (co.summit58.bpmn:camunda-engine)
     * @return True if CockroachDB support is enabled, false if not.
     */
    public static boolean isEnableLegacyCockroachDbSupport() {
        return enableLegacyCockroachDbSupport;
    }
     ...
     *
     * @since 7.12.2 (co.summit58.bpmn:camunda-engine)
     * @return Returns the ProcessEngineConfigurationImpl instance after this property is set.
     */
    public ProcessEngineConfigurationImpl setEnableScriptIO(boolean enableScriptIO) {
